package cn.edu.gdmec.s07150831.filedemo;
...
public class MainActivity extends AppCompatActivity {
    ...
    private File fDownloadCacheDirector;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fDownloadCacheDirector = Environment.getDownloadCacheDirectory();
    ...
    public void downloadCacheDirectory(View v){
        path = fDownloadCacheDirector.getAbsolutePath();
        listFiles(path);
    }
